    ...
    if ($query) {
        echo "<script>alert('Berhasil disimpan');window.location.href='../books/index.php'</script>";
    } else {
        echo "<script>alert('Gagal disimpan');window.location.href='../books/add.php'</script>";
    }
