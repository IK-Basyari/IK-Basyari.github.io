<?php
    ...
    if ($query) {
        echo "<script>alert('Berhasil disimpan');window.location.href='../writers/index.php'</script>";
    } else {
        echo "<script>alert('Gagal disimpan');window.location.href='../writers/add.php'</script>";
    }
