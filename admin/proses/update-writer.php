<?php 
    ...
    if ($queryWriter) {
        echo "<script>alert('Berhasil diperbarui');window.location.href='../writers/index.php'</script>";
    } else {
        echo "<script>alert( 'Gagal diperbarui');window.location.href='../writers/edit.php'</script>";
    }
