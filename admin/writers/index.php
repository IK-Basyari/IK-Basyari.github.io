...
<figure>
  <blockquote class="blockquote">
    <p><h1 class="display-6">Daftar Penulis</h1></p>
  </blockquote>
  <figcaption class="blockquote-footer">
     <cite title="Source Title"><h6>Mencetak Generasi Muda Dengan Membaca</h6></cite>
        ...
        <div class="container">
            <p align = "center">
                <a href="add.php" class="btn btn-sm btn-success">Tambah Penulis</a>
            </p>
            ...
            ?>
              ...
              <div class="card-body">
                ...
                <a href="detail.php?id=<?=$d['id'];?>" class="btn btn-sm btn-secondary">Detail</a>
                <a href="edit.php?id=<?=$d['id'];?>" class="btn btn-sm btn-primary">Update</a>
                <a href="../proses/delete-writer.php?id=<?=$d['id'];?>" class="btn btn-sm btn-danger">Hapus</a>
              </div>
            </div>
        <?php $no++; ?>
            <?php } ?>
