...
<figure>
  <blockquote class="blockquote">
    <p><h1 class="display-6">Daftar Perusahaan<h1></p>
  </blockquote>
...
<div class="container">
    <p align = "center">
        <a href="../publisher/add.php" class="btn btn-sm btn-success">Tambah Produk</a>
    </p>
    <div class="row">
...
<?php
      ...
      <tr>
        ...
        <td>
          ...
          <a href="../proses/delete-publisher.php?id=<?= $d["id"]; ?>"><button class="btn btn-sm btn-danger">Hapus</button></a>
        </td>
      </tr>
  <?php $i++; ?>
<?php } ?>
