...
<figure>
  <blockquote class="blockquote">
    <p><h1 class="display-6">Daftar Admin</h1></p>
  </blockquote>
...
<?php
            ...
            $query = "SELECT * FROM users"; // Query untuk menampilkan data produk
      ...
      <tr>
        ...
        <td>
          ...
          <a href="../proses/delete-user.php?id=<?= $d["id"]; ?>"><button class="btn btn-sm btn-danger">Hapus</button></a>
        </td>
      </tr>
  <?php $i++; ?>
<?php } ?>
