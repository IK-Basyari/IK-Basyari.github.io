...
<figure>
  ...
  <figcaption class="blockquote-footer">
     <cite title="Source Title"><h6>Mencetak Generasi Muda Dengan Membaca</h6></cite>
        ...
        <div class="container">
            <p align = "center">
                <a href="add.php" class="btn btn-sm btn-success">Tambah Produk</a>
            </p>
            ...
            <div class="card" style="width: 18rem; margin:10px">
              <img src="../img/<?= $d['cover']; ?>" class="card-img-top" alt="...">
              <div class="card-body">
                ...
                <a href="../proses/delete-book.php?id=<?=$d['id'];?>" class="btn btn-sm btn-danger">Hapus</a>
              </div>
            </div>
    <?php $no++; ?>
            <?php
